...
public class ArticleService {
    ...
    public Article addarticle(String username,Article article){
        User user= userRebo.findByUsername(username).orElseThrow(()->new NotFoundExcption("I Can't Find The User"));
    ...
    public ArticleDto getarticle(Integer id) {
        Article article=articleRepo.findById(id)
                .orElseThrow(()->new NotFoundExcption("I Can't Find The Article"));
    ...
    public void delete (Integer id){
        Article article=articleRepo.findById(id)
                .orElseThrow(()->new NotFoundExcption("This Article already not exists"));
